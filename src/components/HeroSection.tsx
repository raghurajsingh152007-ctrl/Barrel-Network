      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <motion.img
            ...
            alt="Barrel"
            onClick={scrollToTop}
            className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 object-contain cursor-pointer drop-shadow-[0_0_20px_hsl(32_90%_55%/0.4)] [filter:brightness(0.9)_contrast(1.1)] rounded-md"
            whileHover={{
              scale: 1.15,
              rotate: [0, -8, 8, -4, 0],
